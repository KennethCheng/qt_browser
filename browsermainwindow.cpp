...
*/
    /* Kenneth Cheng fixed */
    // Input
    QMenu *toolsMenu = menuBar()->addMenu(tr("&Input"));
    a = toolsMenu->addAction(tr("Keyboard"), this, SLOT(slotKeyboardWindow(bool)), QKeySequence(tr("Ctrl+K", "")));
    a->setCheckable(true);
...
//m_defaultIcon = QIcon(QLatin1String(":defaulticon.png"));
    ...
    QPixmap *pixmap = new QPixmap(":keyboard.png");
    QIcon icon(*pixmap);
...
void BrowserMainWindow::slotAboutApplication()
{
    QMessageBox::about(this, tr("About"), tr(
        ...
        "<p>Modify by Kenneth Cheng 2010/5/14 "
...
/* Kenneth Cheng added */
void BrowserMainWindow::slotKeyboardWindow(bool enable)
{
    if(enable)
